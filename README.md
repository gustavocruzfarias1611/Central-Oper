...
4. Não defina um diretório de saída manualmente;
5. Faça o deploy com Node.js 22.x.

O `package.json` desta versão já utiliza o build nativo do Next.js, adequado à Vercel.
